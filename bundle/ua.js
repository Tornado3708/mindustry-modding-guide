...
const ua = Object.assign( {}, list )
  ...
  .flipBackLegs          .describe( "(WIP) Розвертає задні ноги павука.(Не сильно впливає)." )
  .flipLegSide           .describe( "(WIP) Міняє місцями ліві та праві ноги(Не сильно впливає)." )
  ...
  .homingDelay           .describe( "Кількість ігрових тіків перед тим як юніт-ракета почне шукати ціль." )
  ...
  .legBaseOffset         .describe( "Відстань від основи ніг до центру юніта." )
  .legContinuousMove     .describe( "Чи буде юніт переминатись з ноги на ногу (для більш природнього вигляду)." )
  .legCount              .describe( "Кількість ніг юніта-павука." )
  .legExtension          .describe( "Для ніг \"без суглобів\". Видовження другої фаланги ноги." )
  ...
  .strafePenalty         .describe( "Штраф для швидкості юніта у вигляді частки, якщо він змінив напрямок руху на протилежний."  )
