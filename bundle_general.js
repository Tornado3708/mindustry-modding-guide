...
const _Color = "Color"
const _UnitCommand = "UnitCommand"
...
list
  .add( "abilities"             , _arr( "Ability" )    , "[]"  , [ _json ] )
  .add( "accel"                 , _float               , 1.1   , [ _json, _movement ] )
  .add( "aimDst"                , _float               , -1    , [ _json ] )
  .add( "allowedInPayloads"     , _boolean             , _true , [ _json ] )
  .add( "allowLegStep"          , _boolean             , _false, [ _json, ..._legs ] )
  .add( "alwaysCreateOutline"   , _boolean             , _false, [ _json ] )
  .add( "alwaysShootWhenMoving" , _boolean             , _false, [ _json ] )
  .add( "ammoCapacity"          , _int                 , -1    , [ _json, _pvp ] )
  .add( "ammoType"              , "ItemAmmoType"       , "Items.copper" )
  .add( "armor"                 , _float               , 0     , [ _json ] )
  .add( "autoFindTarget"        , _boolean             , _true , [ _json ] )
  .add( "baseLegStraightness"   , _float               , 0     , [ _json, ..._legs ] )
  .add( "baseRotateSpeed"       , _float               , 5.5   , [ _json, ..._mech ] )
  .add( "boostMultiplier"       , _float               , 1     , [ _json, ..._boost ] )
  .add( "bounded"               , _boolean             , _true , [ _json ] )
  .add( "buildBeamOffset"       , _float               , 3.8   , [ _json, _build ] )
  .add( "buildRange"            , _float               , 220   , [ _json, _build ] )
  .add( "buildSpeed"            , _float               , -1    , [ _json, _build ] )
  .add( "canAttack"             , _boolean             , _true , [ _json ] )
  .add( "canBoost"              , _boolean             , _false, [ _json, ..._boost ] )
  .add( "canDrown"              , _boolean             , _true , [ _json ] )
  .add( "circleTarget"          , _boolean             , _false, [ _json ] )
  .add( "clipSize"              , _float               , -1    , [ _json, _pvp ] )
  .add( "crashDamageMultiplier" , _float               , 1     , [ _json, _flying ] )
  .add( "crawlSlowdown"         , _float               , 0.5   , [ _json, ..._crawl ] )
  .add( "crawlSlowdownFrac"     , _float               , 0.55  , [ _json, ..._crawl ] )
  .add( "createScorch"          , _boolean             , _true , [ _json, _flying ] )
  .add( "createWreck"           , _boolean             , _true , [ _json, _flying ] )
  .add( "crushDamage"           , _float               , 0     , [ _json, _flying ] )
  .add( "commands"              , _arr("UnitCommand")  , "[]"  , [ _json, _command ] )
  .add( "coreUnitDocking"       , _boolean             , _false, [ _json ] )
  .add( "drag"                  , _float               , 0.3   , [ _json ] )
  .add( "deathExplosionEffect"  , unknown              , "Fx.dynamicExplosion", [ _json, _effect ] )
  .add( "deathSound"            , _Sounds              , "Sounds.bang"        , [ _json, _effect ] )
  .add( "defaultCommand"        , _UnitCommand         , "null" , [ _json, _command ] )
  .add( "drawBody"              , _boolean             , _true , [ _json, _design ] )
  .add( "drawBuildBeam"         , _boolean             , _true , [ _json, _build ] )
  .add( "drawCell"              , _boolean             , _true , [ _json, _design ] )
  .add( "drawItems"             , _boolean             , _true , [ _json, _design ] )
  .add( "drawMinimap"           , _boolean             , _true , [ _json ] ) 
  .add( "drawShields"           , _boolean             , _true , [ _json, _design ] )
  .add( "drownTimeMultiplier"   , _float               , 1     , [ _json ] )
  .add( "engineColor"           , _Color               , _null , [ _json ] )
  .add( "engineLayer"           , _float               , -1    , [ _json, _design ] )
  .add( "engineOffset"          , _float               , 5     , [ _json ] )
  .add( "engines"               , _arr(_UnitCommand)   , "[]"  , [ _json ] )
  .add( "engineSize"            , _float               , 2.5   , [ _json ] )
  ...
  .add( "immunities"            , _arr( "ObjectSet<StatusEffect>" ), "[]" )
  .add( "killable"              , _boolean             , _true )
  .add( "legBaseOffset"         , _float               , 0     , [ ..._legs ] )
  .add( "legContinuousMove"     , _boolean             , _false, [ ..._legs ] )
  ...
  .add( "parts"                 , _arr( "DrawPart[]" ) , "[]", [ _design ] )
  ...
  .add( "speed"                 , _float               , 1.1  , [ _json, _movement ] )
